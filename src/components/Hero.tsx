          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Custom Chatbots designed to create customers out of visitors. Enhanced to convert users to clients.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="https://autobots-ai.com">Get started</Button>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
                ...
                <div className="rounded-2xl overflow-hidden">  
                    <Image src="/autobots-dashboard.png" width={600} height={400} alt="autobots dashboard" priority/>
                </div>
              </div>
            </div>
          </div>
